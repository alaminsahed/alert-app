...
export const usePost = (
  ...
  const mutation = useMutation(createFn, options);
...
export const usePut = (
  ...
  const mutation = useMutation(updateFn, options);
...
export const usePatch = (
  ...
  const mutation = useMutation(patchFn, options);
...
export const useDelete = (
  ...
  const mutation = useMutation(deleteFn, options);
